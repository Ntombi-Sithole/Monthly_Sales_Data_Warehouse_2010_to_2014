...
| birthdate | DATE | The date of birth of the customer, formatted as YYYY-MM-DD (e.g., 1980-06-12). |
...
| product_name | NVARCHAR(50) | Descriptive name of the product, including key details such as the type, color, and size. |
...
| quantity | INT | The number of units of the product oredered for the line item (e.g., 1). |
